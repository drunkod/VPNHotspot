...
class ProxyOnlyController(
    ...
    private suspend fun cleanupApplied(
        ...
        val firewallNeedsClean = fw != null && !firewallCurrent && !firewallDominated // case C

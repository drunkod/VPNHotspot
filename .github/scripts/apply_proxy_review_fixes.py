...
controller = "mobile/src/main/java/be/mygod/vpnhotspot/proxy/ProxyOnlyController.kt"
replace_once(
    controller,
...
replace_once(
    matrix,
    "SanitationResult(sessionId = 9, epoch = 7)",
    "SanitationResult(sessionId = 9, epoch = 7, daemonGeneration = 11)",
)
replace_once(
    matrix,
...
""" + rust_test_marker
replace_once(rust_mod, rust_test_marker, rust_tests)

control = "mobile/src/main/rust/vpnhotspotd/src/control.rs"
replace_once(
    control,
...
""" + session_test_marker
replace_once(session, session_test_marker, session_tests)
